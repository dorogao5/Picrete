...
- Полная backend-архитектура: `ARCHITECTURE.md`
- Frontend: `../Front-Picrete/README.md`
- Frontend architecture: `../Front-Picrete/ARCHITECTURE.md`

## Важно по безопасности

- Telegram token и другие секреты из `.env` не должны попадать в публичные каналы.
- Если токен уже был раскрыт, его нужно ротировать до production rollout.
